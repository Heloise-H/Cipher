...
public class Polyal {
  ...
  public Polyal(){
	  //构造函数
	  JFrame frame=new JFrame("Polyalphabetic Cipher");
	  ...
	  encrypt.addActionListener(new ActionListener(){
		  public void actionPerformed(ActionEvent e){
			  ...
			  String S_cipher=Polyalphabetic.encrypt(S_plain, S_key);
	  ...
	  decrypt.addActionListener(new ActionListener(){
		  public void actionPerformed(ActionEvent e){
			  ...
			  String S_plain=Polyalphabetic.decrypt(S_cipher, S_key);
